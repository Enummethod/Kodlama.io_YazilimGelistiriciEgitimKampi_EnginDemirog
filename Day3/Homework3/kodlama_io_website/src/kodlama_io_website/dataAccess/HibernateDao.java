...
public class HibernateDao implements CourseDao, CategoryDao, InstructorDao{
	...
	public void deleteCategory(Category category) {
		System.out.println("Hibernate ile " + category.getCategoryName() + " Kategorisi silindi...");
	...
	public void addInstructor(Instructor instructor) {
		System.out.println("Hibernate ile " + instructor.getFirstName() + "" + instructor.getLastName()+ " adlý Eðitmen eklendi...");
	}

	@Override
	public void deleteInstructor(Instructor instructor) {
		System.out.println("Hibernate ile " + instructor.getFirstName() + "" + instructor.getLastName()+ " adlý Eðitmen silindi...");
	}
